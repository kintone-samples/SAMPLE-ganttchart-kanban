...
var KintoneRequestConfigBuilder = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_k) {
                switch (_k.label) {
                    ...
                    case 4:
                        if (!(params instanceof FormData)) return [3 /*break*/, 6];
                        return [4 /*yield*/, this.buildData(params)];
                    case 5:
                        formData = _k.sent();
    ...
    KintoneRequestConfigBuilder.prototype.buildHeaders = function (params) {
        ...
        switch (this.auth.type) {
            case "password": {
                return __assign(__assign({}, commonHeaders), { "X-Cybozu-Authorization": Base64.encode("".concat(this.auth.username, ":").concat(this.auth.password)) });
            }
            case "apiToken": {
