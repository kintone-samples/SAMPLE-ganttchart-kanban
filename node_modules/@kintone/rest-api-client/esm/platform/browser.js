...
export var getRequestToken = function () { return __awaiter(void 0, void 0, void 0, function () {
    var _a, _b;
...
export var buildPlatformDependentConfig = function () {
    return {};
};
export var buildHeaders = function () {
    return {};
};
...
export var buildBaseUrl = function (baseUrl) {
    ...
    var _a = location, host = _a.host, protocol = _a.protocol;
